...
subplot_titles: Final[tuple[str, ...]] = ('Кривая блеска (абсолютной звёздной величины)',
                                          'Кривая расстояния в проекции на плоскость, перпендикулярную лучу зрения',
                                          'Кривая расстояния между центрами',
                                          'Кривая истинной аномалии')
subplot_labels: Final[tuple[str, ...]] = ()
stars_intersect_error: Final[str] = u'Неправильные входные данные, моделирование невозможно! В периастре звёзды пересекаются или подходят друг к другу на расстояние, меньшее суммы радиуов звёзд! Способы устранения ошибки: \n - уменьшить эксцентриситет, приблизив орбиту к круговой \n - увеличить большую полуось орбиты \n - уменьшить радиусы звёзд'
